<template>
    <nav class="bg-gray-600 dark:bg-gray-800">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    <button
                        ...
                        class="
                            p-1 border-2 border-transparent rounded-full
                            focus:outline-none 
                            text-gray-400 hover:text-white focus:text-white focus:bg-gray-700
                    ...
                    >
                        <svg v-if="dark" eviewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" >
                            <path 
                                fill="currentColor"
                                d="M21 16.1529C19.1593 16.9855 17.1086 17.2374 15.1211 16.8751C13.1336 16.5128 11.3036 15.5535 9.87509 14.1249C8.44655 12.6964 7.48723 10.8665 7.12493 8.87894C6.76263 6.89144 7.01455 4.84072 7.84714 3C6.38172 3.66225 5.09883 4.67013 4.10854 5.93716C3.11824 7.2042 2.45011 8.69256 2.16146 10.2746C1.87281 11.8566 1.97225 13.485 2.45126 15.0201C2.93028 16.5552 3.77456 17.9512 4.91167 19.0883C6.04878 20.2254 7.44478 21.0697 8.9799 21.5487C10.515 22.0277 12.1434 22.1272 13.7254 21.8385C15.3074 21.5499 16.7958 20.8818 18.0628 19.8915C19.3299 18.9012 20.3377 17.6183 21 16.1529Z">
                            </path>
                        </svg>
                        <svg v-else viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" >
                            <path 
                                fill-rule="evenodd" 
                                clip-rule="evenodd" 
                                fill="currentColor"
