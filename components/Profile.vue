<template>
    <div class="flexItemsCenter">
        ...
        <div class="ml-3">
            <div class="profileItem text-base flexItemsCenter">
                ...
                <a href="https://github.com/ingridkao"
                    ...
                    class="
                        mx-2 rounded-md focus:outline-none
                        fill-gray-500 hover:fill-gray-600 
                        dark:hover:fill-gray-200
                    "
                >
                    <svg 
                        class="w-5 h-5"
                ...
                <a href="https://www.linkedin.com/in/ingrid-kao-024056145/"
                    title="My linkedin"
                    target="_blank" rel="noreferrer noopenner"
                    class="
                        mx-2 rounded-md focus:outline-none
            ...
            <div class="profileItem my-3 text-sm text-gray-500">
                ingrid7613@gmail.com
            </div>
        </div>
    </div>
</template>
